...
<table class="acuity" summary="Hostsummary" align="center">
    <thead>
    	<tr>
    		<th scope="col" class="topleft">Value</th>
        	<th scope="col" class="rounded-company">Yellow</th>
            <th scope="col" class="topright">Red</th>
   </tr></thead>

        
        <tr>
        <td class="blue">Hashrate Update Timer (seconds)</td>
        <td colspan="2"><input type=text name="updatetime" value="<?php echo $config->updatetime?>"></td>
        </tr>
         <!--
       <tr>
        <td class="blue">GPU Temperature</td>
        <td data-label="Yellow"><input type=text name="yellowtemp" value="<?php echo $config->yellowtemp?>"></td>
        <td data-label="Red"><input type=text name="maxtemp" value="<?php echo $config->maxtemp?>"></td>
        </tr>
         -->
       <tr>
        <td class="blue">Rejects</td>
        <td data-label="Yellow"><input type=text name="yellowrejects" value="<?php echo $config->yellowrejects?>"></td>
        <td data-label="Red"><input type=text name="maxrejects" value="<?php echo $config->maxrejects?>"></td>        
        </tr>
        <tr>
        <td class="blue">Discards</td>
        <td data-label="Yellow"><input type=text name="yellowdiscards" value="<?php echo $config->yellowdiscards?>"></td>
        <td data-label="Red"><input type=text name="maxdiscards" value="<?php echo $config->maxdiscards?>"></td>        
        </tr>
        <tr>
        <td class="blue">Stales</td>
	<td data-label="Yellow"><input type=text name="yellowstales" value="<?php echo $config->yellowstales?>"></td>
        <td data-label="Red"><input type=text name="maxstales" value="<?php echo $config->maxstales?>"></td>        
        </tr>
        <tr>
        <td class="blue">Get Fails</td>
        <td data-label="Yellow"><input type=text name="yellowgetfails" value="<?php echo $config->yellowgetfails?>"></td>
        <td data-label="Red"><input type=text name="maxgetfails" value="<?php echo $config->maxgetfails?>"></td>        
        </tr>   
        <tr>  
        <td class="blue">Rem Fails</td>
        <td data-label="Yellow"><input type=text name="yellowremfails" value="<?php echo $config->yellowremfails?>"></td>
        <td data-label="Red"><input type=text name="maxremfails" value="<?php echo $config->maxremfails?>"></td>        
        </tr> 
        <!--
        <tr>
        <td class="blue">Fan Percent</td>
        <td data-label="Yellow"><input type=text name="yellowfan" value="<?php echo $config->yellowfan?>"></td>
        <td data-label="Red"><input type=text name="maxfan" value="<?php echo $config->maxfan?>"></td>        
        </tr>
        -->
        <tr>
        <td class="blue">min. % of desired 5s MH/s</td>
        <td data-label="Yellow"><input type=text name="yellowgessper" value="<?php echo $config->yellowgessper?>"></td>
        <td data-label="Red"><input type=text name="maxgessper" value="<?php echo $config->maxgessper?>"></td>        
        </tr>
        <tr>
        <td class="blue">min. % of desired average MH/s</td>
        <td data-label="Yellow"><input type=text name="yellowavgmhper" value="<?php echo $config->yellowavgmhper?>"></td>
        <td data-label="Red"><input type=text name="maxavgmhper" value="<?php echo $config->maxavgmhper?>"></td>        
        </tr>
        <!--
        <tr>
        ...
        -->
        <tr>
        <td colspan="3" class="blue"><input type=submit name=saveconf class="button" value="Save"></td>
        </tr> 
</table>
